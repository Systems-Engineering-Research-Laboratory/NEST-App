...
namespace NEST_App.DAL
{
    public class NestDatabaseInitializer : IDatabaseInitializer<NestContainer>
    {
        void IDatabaseInitializer<NestContainer>.InitializeDatabase(NestContainer context)
        {
            ...
            {
                new FlightState{ Position = DbGeography.FromText("POINT(-118.529 34.2417 400)"), VelocityX = 0, VelocityY = 0, VelocityZ = 0, Yaw = 0, Roll = 0, Pitch = 0, YawRate = 0, RollRate = 0, PitchRate = 0, BatteryLevel = .19, UAVId = 1 },
